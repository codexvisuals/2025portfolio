...
// Marquee link to works section open
p.on("click", function(e) {
    e.preventDefault();
    s.addClass("animate-out");
    setTimeout(function() {
      s.removeClass("active animate-in");
      a.addClass("active animate-in");
      p.addClass("active-link");
    }, 500);
    setTimeout(function() {
      i.addClass("inner-is-visible");
      s.removeClass("animate-out");
    }, 1500);
  });
